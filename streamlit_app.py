...
<style>
    ...
    /* Primary buttons - medium steel blue */
    .stButton > button {
    ...
    /* Navigation buttons in sidebar - steel blue, white text */
    ...
    /* Sidebar success/info boxes - stay in blue family */
